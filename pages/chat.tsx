...
const ChatPage: React.FC = () => {
  ...
  const meta = {
    ...
    type: 'website', // Fügen Sie den Typ hinzu, z.B. "website"
  }
  ...
  return (
    <div>
      ...
      <iframe
        src='https://togetherai-einfachllamistral.hf.space' // Ersetzen Sie dies mit der URL Ihres Huggingface-Modells
        frameBorder='0'
        style={{ width: '100%', height: '900px' }} // Passen Sie die Größe nach Bedarf an
      ></iframe>
    </div>
  )
}
